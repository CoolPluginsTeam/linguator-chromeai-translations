...
const Providers = (props) => {
    ...
    const btnId = `ewt-page-translation-${serviceId}-btn`;

    return (
<tr>
<td className="ewt-page-translation-provider-name">
  {ActiveService.Logo}
...
<td>
  {ActiveService.ButtonDisabled ? ActiveService.ErrorMessage : (
    <div
      ...
      className="ewt-page-translation-service-btn button button-primary"
...
<td>
  <a href={ActiveService.Docs} target="_blank" rel="noopener noreferrer" className="ewt-page-translation-doc-icon">
