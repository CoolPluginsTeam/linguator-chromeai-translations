...
const AddProgressBar = (provider) => {
    ...
    const progressBarSelector = "#ewt_page_translation_strings_model .ewt_page_translation_translate_progress";

    if (!document.querySelector(`#ewt-page-translation-${provider}-progress-bar`)) {
        const progressBar = jQuery(`
            <div id="ewt-page-translation-${provider}-progress-bar" class="ewt-page-translation-translate-progress-bar">
