...
export default (props) => {
    ...
    const Services = {
        localAiTranslator: {
            ...
            ErrorMessage: props.localAiTranslatorButtonDisabled ? <div className="lmat-page-translation-provider-error button button-primary" onClick={() => openErrorModalHandler("localAiTranslator")}><img src={errorIcon} alt="error" /> {__('View Error', 'linguator-multilingual-chromeai-translation')}</div> : <></>,
