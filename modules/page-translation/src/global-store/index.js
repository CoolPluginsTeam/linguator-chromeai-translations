...
// Create a Redux store named 'block-ewtPageTranslation/translate' with the specified reducer, actions, and selectors.
const store = createReduxStore('block-ewtPageTranslation/translate', {
