...
const TranslationConfig = ({ data, setData }) => {
    ...
    async function SaveSettings() {
        try {
            ...
            if (error.message.includes(__("Linguator was unable to access", "linguator-multilingual-chromeai-translation"))) {
    ...
    const postStatusOptions = [
        {
            heading: __('Published', 'linguator-multilingual-chromeai-translation'),
            value: 'publish'
        },
        {
            heading: __('Draft', 'linguator-multilingual-chromeai-translation'),
            value: 'draft'
        }
    ]
    ...
    const slugTranslationOptions = [
        {
            heading: __('Use Translated Title', 'linguator-multilingual-chromeai-translation'),
            value: 'title_translate'
        },
        {
            heading: __('Translate Original Slug', 'linguator-multilingual-chromeai-translation'),
            value: 'slug_translate'
        },
        {
            heading: __('Keep Original Slug', 'linguator-multilingual-chromeai-translation'),
            value: 'slug_keep'
        }
    ]
        ...
        <Container className='bg-white p-10 rounded-lg' cols="1" containerType='grid'>
            <Container className='flex items-center'>
                <Container.Item className='flex w-full justify-between px-4 gap-6'>
                    <h1 className='font-bold'>{__('Translation Settings', 'linguator-multilingual-chromeai-translation')}</h1>
                    <Button
            ...
            <Container.Item className='p-6 rounded-lg' style={{ border: "1px solid #e5e7eb" }}>
                <Label size='md' className='font-bold flex items-center gap-2'>
                    ...
                    {__('Service Provider', 'linguator-multilingual-chromeai-translation')}
                </Label>
                <Label variant='help'>
                    {__('Select at least one translation service provider below. You can enable multiple providers and choose the one that best fits your needs.', 'linguator-multilingual-chromeai-translation')}
                </Label>
                        ...
                        <div className='switcher p-6 rounded-lg'>
                            <Container.Item >
                                <h3 className='flex items-center gap-2'>
                                    ...
                                    {__('Chrome Local AI Translation', 'linguator-multilingual-chromeai-translation')}
                                </h3>
                                <p>
                                    {__('Chrome Local AI Translation uses Chrome Local AI API to translate text.', 'linguator-multilingual-chromeai-translation')}
                                </p>
                            </Container.Item>
            ...
            <Container.Item>
                <Label size='md' className='font-bold flex items-center gap-2'>
                    ...
                    {__('Bulk Translation – Default Post Status', 'linguator-multilingual-chromeai-translation')}
                </Label>
                <Label variant='help'>
                    {__('This is the default post status for bulk translation.', 'linguator-multilingual-chromeai-translation')}
                </Label>
            ...
            <Container.Item>
                <Label size='md' className='font-bold flex items-center gap-2'>
                    ...
                    {__('Slug Translation Settings', 'linguator-multilingual-chromeai-translation')}
                </Label>
                <Label variant='help'>{__('Choose how post slugs (URLs) are generated when content is translated.', 'linguator-multilingual-chromeai-translation')}</Label>
                <div style={{ marginTop: "20px" }}>
                    <RadioButton.Group>
