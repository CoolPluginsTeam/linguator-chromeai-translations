      ...
      <div className='w-full'>
        <div className='w-full flex flex-col gap-8 rounded-lg'>
          <Container className='flex flex-col p-6  bg-white border border-gray-200 rounded-lg shadow-sm'>
            <Container.Item>
              <h2 className='text-lg font-semibold text-gray-900 mb-2'>{__('Auto Translation Status', 'easy-web-translator')}</h2>
              <Container.Item className=''>
                ...
                <p className='text-sm text-gray-600 m-0'>{__('Total Characters Translated!', 'easy-web-translator')}</p>
              </Container.Item>
            </Container.Item>
            ...
            <Container.Item className='w-full'>
              <Container.Item className='flex flex-col gap-1'>
                <div className='flex justify-between items-center'>
                  <h4 className='text-sm text-gray-700 m-0'>{__('Total Strings', 'easy-web-translator')}</h4>
                  <p className='text-sm font-medium text-gray-900 m-0'>{window.lmat_settings?.translations_data?.total_string || 0}</p>
                </div>
                <div className='flex justify-between items-center'>
                  <h4 className='text-sm text-gray-700 m-0'>{__('Total Pages / Posts', 'easy-web-translator')}</h4>
                  <p className='text-sm font-medium text-gray-900 m-0'>{window.lmat_settings?.translations_data?.total_pages || 0}</p>
                </div>
                <div className='flex justify-between items-center'>
                  <h4 className='text-sm text-gray-700 m-0'>{__('Time Taken', 'easy-web-translator')}</h4>
                  <p className='text-sm font-medium text-gray-900 m-0'>{window.lmat_settings?.translations_data?.total_time || 0}</p>
                </div>
                <div className='flex justify-between gap-2'>
                  <div className='flex flex-col gap-1'>
                    <h4 className='text-sm text-gray-700 m-0 text-nowrap'>{__('Service Providers', 'easy-web-translator')}</h4>
                  </div>
