...
class LMAT_Admin_Feedback {
	...
	private $plugin_name    = 'Linguator – Multilingual AI Translation';
	...
	public function show_deactivate_feedback_popup() {
		...
		$deactivate_reasons = array(
			'didnt_work_as_expected'         => array(
				'title'             => __( 'The plugin didn\'t work as expected.', 'linguator-multilingual-chromeai-translation' ),
				'input_placeholder' => 'What did you expect?',
			),
			'found_a_better_plugin'          => array(
				'title'             => __( 'I found a better plugin.', 'linguator-multilingual-chromeai-translation' ),
				'input_placeholder' => __( 'Please share which plugin.', 'linguator-multilingual-chromeai-translation' ),
			),
			'couldnt_get_the_plugin_to_work' => array(
				'title'             => __( 'The plugin is not working.', 'linguator-multilingual-chromeai-translation' ),
				'input_placeholder' => 'Please share your issue. So we can fix that for other users.',
			),
			'temporary_deactivation'         => array(
				'title'             => __( 'It\'s a temporary deactivation.', 'linguator-multilingual-chromeai-translation' ),
				'input_placeholder' => '',
			),
			'other'                          => array(
				'title'             => __( 'Other reason.', 'linguator-multilingual-chromeai-translation' ),
				'input_placeholder' => __( 'Please share the reason.', 'linguator-multilingual-chromeai-translation' ),
			),
		);
		...
		<div id="cool-plugins-feedback-<?php echo esc_attr( $this->plugin_slug ); ?>" class="hide-feedback-popup">
			...
			<div class="cp-feedback-header">
				<div class="cp-feedback-title"><?php echo esc_html__( 'Quick Feedback', 'linguator-multilingual-chromeai-translation' ); ?></div>
			...
			<div class="cp-feedback-form-wrapper">
				<div class="cp-feedback-form-title"><?php echo esc_html__( 'If you have a moment, please share the reason for deactivating this plugin.', 'linguator-multilingual-chromeai-translation' ); ?></div>
    ...
    function submit_deactivation_response() {
		if ( ! isset( $_POST['_wpnonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['_wpnonce'] ) ), '_cool-plugins_deactivate_feedback_nonce' ) ) {
			...
			$deactivate_reasons = array(
				...
				'other'                          => array(
					'title'             => __( 'Other', 'linguator-multilingual-chromeai-translation' ),
					'input_placeholder' => __( 'Please share the reason.', 'linguator-multilingual-chromeai-translation' ),
				),
			);
